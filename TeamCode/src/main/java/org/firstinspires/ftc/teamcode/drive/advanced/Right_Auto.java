...
public class Right_Auto extends LinearOpMode {
    ...
    Pose2d traj3end = new Pose2d(58.1, -20.7, Math.toRadians(115));
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory trajectory2 = drive.trajectoryBuilder(trajectory1.end())
                .splineTo(new Vector2d(56.2, -21.5), Math.toRadians(115))
                .build();
        ...
        while (opModeIsActive() && !isStopRequested()) {
            ...
            switch (currentState) {
                ...
                case WAIT_1:
                    ...
                    //creates a slight pause
                    // If so, move on to the TRAJECTORY_4 state
                    if (waitTimer1.seconds() >= waitTime1) {
                        ...
                        if(scored != 6) {
                            Trajectory trajectory4 = drive.trajectoryBuilder(PoseStorage.currentPose)
                                    .lineToLinearHeading(new Pose2d(distance, -14.5, Math.toRadians(90)))
                                    .build();
                ...
                case TRAJECTORY_4:
                    ...
                    break;
                case DEPOSITE:
                    // Checks how many cones were scored
                    //if the desired amount is met move on to TRAJECTORY_5 to park
                    // If not, move onto the next state, ROTATE
                ...
                case WAIT_3:
                    ...
                    if (lift.pos() >= 650-offset) {
                        Trajectory trajectory3 = drive.trajectoryBuilder(PoseStorage.currentPose)
                                .lineToLinearHeading(new Pose2d(55.75, -21.5, Math.toRadians(115)))
                                .build();
                        turret_target = 330;
                ...
                case TRAJECTORY_5:
                    ...
                    // `isBusy() == true` while it's following the trajectory
                    // Once `isBusy() == false`, the trajectory follower signals that it is finished
                    // We move on to the next state, IDLE
                    if (!drive.isBusy()) {
            ...
            drive.update();
            // We update our lift and turret PID continuously in the background, regardless of state
            lift.update();
            turret.update();
