...
public class Left_Auto_High extends LinearOpMode {
    ...
    Pose2d traj3end = new Pose2d(-51.0, -20.5, Math.toRadians(180));
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory trajectory2 = drive.trajectoryBuilder(trajectory1.end())
                .lineToLinearHeading(new Pose2d(-29.2, -12.75, Math.toRadians(180)))
                .build();
        //The next three trajectories are for parking
        //parking location 3
        Trajectory trajectory5 = drive.trajectoryBuilder(traj3end)
                .lineToConstantHeading(new Vector2d(-59.5, -17))
                .build();
        //parking location 2
        ...
        Trajectory trajectory7 = drive.trajectoryBuilder(traj3end)
                .lineToConstantHeading(new Vector2d(-11, -17))
                .build();
                    ...
                    if (waitTimer1.seconds() >= waitTime1) {
                        ...
                        if(scored != 5) {
                            Trajectory trajectory4 = drive.trajectoryBuilder(PoseStorage.currentPose)
                                    .lineToLinearHeading(new Pose2d(distance, -16.8, Math.toRadians(180)))
                                    .build();
                    ...
                    if (lift.pos() >= 650-offset) {
                        if(scored < 4) {
                            Trajectory trajectory3 = drive.trajectoryBuilder(PoseStorage.currentPose)
                                    .lineToLinearHeading(new Pose2d(distance_2, -13.15, Math.toRadians(180)))
                                    .build();
                            drive.followTrajectoryAsync(trajectory3);
                        } else {
                            Trajectory trajectory8 = drive.trajectoryBuilder(PoseStorage.currentPose)
                                    .lineToLinearHeading(new Pose2d(-48.25, -18.5, Math.toRadians(180)))
                                    .build();
